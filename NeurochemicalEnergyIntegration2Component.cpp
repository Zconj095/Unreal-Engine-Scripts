#include "NeurochemicalEnergyIntegration2Component.h"
#include "Logging/LogMacros.h"
#include "Math/UnrealMathUtility.h"

UNeurochemicalEnergyIntegration2Component::UNeurochemicalEnergyIntegration2Component()
{
	PrimaryComponentTick.bCanEverTick = false;
}

void UNeurochemicalEnergyIntegration2Component::BeginPlay()
{
	Super::BeginPlay();
...
float UNeurochemicalEnergyIntegration2Component::CalculateNeurochemicalEnergy() const
{
	if (NumSamples <= 0 || FMath::IsNearlyEqual(StartTime, EndTime))
	{
		UE_LOG(LogTemp, Warning, TEXT("Invalid integration range or zero samples."));
		return 0.0f;
	}
